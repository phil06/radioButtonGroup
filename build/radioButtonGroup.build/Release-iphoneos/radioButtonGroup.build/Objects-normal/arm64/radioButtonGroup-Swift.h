...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="radioButtonGroup",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)radioButtonSelectedWithCurrentIdx:(NSInteger)currentIdx sectionIdx:(NSInteger)sectionIdx colIdx:(NSInteger)colIdx;
@end
...
SWIFT_CLASS("_TtC16radioButtonGroup15RadioButtonView")
